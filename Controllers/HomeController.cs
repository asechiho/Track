...
namespace Cars.Classes
{
	public static class ReadSqlServer
	{
		...
		public static List<ProductInfo> ReadProductInfos(SqlConnection _connect,string _sql, int _count)
		{
			...
			int i  = 0;
			string sqlQuery =
			"select id, Maker, Model, Year_creation, Price, DAY(Date_add), DATENAME(MONTH,Date_add),YEAR(Date_add), Image, Engine, V_engine, Chassis, Cabin, Horse_power, Color,Type_car, Power, Max_KM, Max_power_KM, Max_KM_revolution from Product";
		...
		public static List<ProductInfo> ReadProductInfos(SqlConnection _connect, string _sql)
		{
			...
			string sqlQuery =
			"select TOP 6 id, Maker, Model, Year_creation, Price, DAY(Date_add), DATENAME(MONTH,Date_add),YEAR(Date_add), Image, Engine, V_engine, Chassis, Cabin, Horse_power, Color,Type_car, Power, Max_KM, Max_power_KM, Max_KM_revolution from Product";
		...
		public static ProductInfo ReadProductId(SqlConnection _connect, int? _id)
		{
			...
			string sqlQuery =
			"select id, Maker, Model, Year_creation, Price, DAY(Date_add), DATENAME(MONTH,Date_add),YEAR(Date_add), Image, Engine, V_engine, Chassis, Cabin, Horse_power, Color,Type_car, Power, Max_KM, Max_power_KM, Max_KM_revolution from Product where id = " + _id;
